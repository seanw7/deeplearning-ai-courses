...
# this expects to find a .env file at the directory above the lesson.                                                                                                                     # the format for that file is (without the comment)                                                                                                                                       #API_KEYNAME=AStringThatIsTheLongAPIKeyFromSomeService                                                                                                                                     
def load_env():
...
if execution_time_seconds > 0:
    ...
    tokens_per_second = float('inf')  # Handle division by zero if execution time is negligible
